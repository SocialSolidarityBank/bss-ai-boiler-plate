...
**한국어** · [English](./README.upstream.en.md) · [설치 흐름 보기 ↗](https://heoooooon.github.io/lazy-starter-kit/) · [변경 이력](./CHANGELOG.md)
...
```sh
STARTER_KIT_BRANCH=v0.3.0 bash -c "$(curl -fsSL https://raw.githubusercontent.com/Heoooooon/lazy-starter-kit/v0.3.0/install.sh)"
```
