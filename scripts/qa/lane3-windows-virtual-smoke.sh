...
(
  ...
  assert_contains "$ROOT/windows/scripts/recommendations.ps1" 'Superpowers Planning Pack'
  assert_contains "$ROOT/windows/scripts/recommendations.ps1" 'brainstorming'
  assert_contains "$ROOT/windows/scripts/recommendations.ps1" 'writing-plans'
