...
(
  ...
  assert_contains "$ROOT/windows/scripts/recommendations.ps1" 'Superpowers Debug/Verify Pack'
  assert_contains "$ROOT/windows/scripts/recommendations.ps1" 'systematic-debugging'
  assert_contains "$ROOT/windows/scripts/recommendations.ps1" 'verification-before-completion'
