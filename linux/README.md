...
| **AI agents** | **Claude Code** (`claude`), **codex**, optional Matt Pocock Skills, optional **lazycodex** (OmO), optional Superpowers Planning Pack (`brainstorming` + `writing-plans`), **Hermes Agent** (`hermes`, Nous Research) |
