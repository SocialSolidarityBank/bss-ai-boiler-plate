...
> 이 문서는 현재 BSS AI Helper Linux 설치 계약을 설명합니다. 원본 출처와 보관된 upstream README는 [`../NOTICE`](../NOTICE)와 저장소 루트의 upstream README 스냅샷에서 확인할 수 있습니다.
...
터미널에서는 `bss-ai-helper`, `ai-helper`, `bss-ai`를 사용할 수 있습니다. 개발자와 CI는 `--classic`, `--status`, `--dry-run`, `--list`를 계속 사용할 수 있습니다.
...
marked managed blocks (`# >>> bss-ai-boilerplate:* >>>`) that get replaced (never
